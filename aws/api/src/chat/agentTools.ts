...
export const BRAIN_LINEAGE: AgentToolDef = {
  ...
  description:
    ...
    'state it as fact. Give a ticket key (e.g. PROJ-14), a meeting title, or an item name.',
  inputSchema: {
    type: 'object',
    properties: {
      anchor: { type: 'string', description: 'A ticket key (e.g. PROJ-14), meeting title, or item name to trace.' },
    },
    required: ['anchor'],
  },
};
