...
under two `workspace_id`s — the "drift" — e.g. SCRUM-7 under `7a2ddf96` *and* `879647b1`.)
...
### The concrete trace (your SCRUM-7)
Jira authorized in spaces `ebf64c10` + `d75c7852` → sync writes a correct row in each. A meeting in
space `02518268` linked to SCRUM-7 (B, workspace-grouped brainLink) → the sentinel/default SCRUM-7
copy was **re-homed into `02518268`** (C) → SCRUM-7 now appears in a space that never connected Jira,
